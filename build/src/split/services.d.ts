 ...
 */
export declare const createSplit: (marketplace: IMarketplace, transactionId: string, body: ISplitValue | ISplitPercentage) => Promise<import("axios").AxiosResponse<unknown, unknown>>;
/**
 * Criar Split por valor ou porcentagem recipient assume o valor total da taxa
 */
export declare const createSplitRecepient: (marketplace: IMarketplace, transactionId: string, body: ISplitRecipientValue | ISplitRecipientPercentage) => Promise<import("axios").AxiosResponse<unknown, unknown>>;
/**
 * Criar Split por valor recipient assume o valor total da taxa
 */
export declare const createSplitRecepientGross: (marketplace: IMarketplace, transactionId: string, body: ISplitGrossValue) => Promise<import("axios").AxiosResponse<unknown, unknown>>;
/**
